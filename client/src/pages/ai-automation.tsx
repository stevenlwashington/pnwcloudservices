...
import { Bot, BarChart, FileText, Layers, Shield, Rocket } from "lucide-react";
import heroImage from "@assets/stock_images/artificial_intellige_9d4db54f.jpg"; // Reusing existing image
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <ul className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center gap-3 bg-white p-4 rounded-sm border border-border shadow-sm">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-accent-orange/10 rounded-md flex items-center justify-center">
              ...
              <div className="space-y-8">
                <div>
                  <h4 className="font-bold text-lg mb-3 text-secondary">B2B AI Sales Agents</h4>
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex gap-2"><span className="text-secondary">•</span> Qualify inbound leads using existing data and behavioral signals</li>
                    <li className="flex gap-2"><span className="text-secondary">•</span> Route to the right reps based on territory, segment, or product line</li>
                    <li className="flex gap-2"><span className="text-secondary">•</span> Draft personalized outreach and follow-ups that match your tone and brand</li>
                    <li className="flex gap-2"><span className="text-secondary">•</span> Update Salesforce or your CRM automatically with key callouts and next steps</li>
                  </ul>
                </div>

                <div>
                  <h4 className="font-bold text-lg mb-3 text-secondary">B2C AI Sales Agents</h4>
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex gap-2"><span className="text-secondary">•</span> Guide customers through complex product choices</li>
                    <li className="flex gap-2"><span className="text-secondary">•</span> Answer pre-purchase questions using trusted, curated knowledge</li>
                    <li className="flex gap-2"><span className="text-secondary">•</span> Hand off to human agents gracefully when needed</li>
                    <li className="flex gap-2"><span className="text-secondary">•</span> Capture intent and feedback to improve journeys over time</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-3xl">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="space-y-4">
                <h3 className="font-bold text-lg text-secondary">We help you:</h3>
              ...
              <div className="space-y-4">
                <h3 className="font-bold text-lg text-secondary">Working with:</h3>
                <ul className="space-y-3 text-white/70">
            ...
            <div className="bg-white/10 p-6 rounded-lg border border-white/20 inline-block">
              <p className="font-bold text-lg">The goal: shorten the loop between <br/>
              <span className="text-secondary">signal → insight → decision → change</span>.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="p-4 bg-background rounded border border-border text-sm font-medium text-foreground">
                    {item}
                  </div>
                ))}
              </div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-12">
            {[
              ...
              <div key={i} className="bg-white p-6 rounded-lg border border-border shadow-sm w-64 hover:border-secondary/50 transition-colors">
          ...
          <div className="max-w-4xl mx-auto border border-border rounded-xl p-8 md:p-12 shadow-lg relative overflow-hidden">
            ...
            <div className="bg-background p-6 rounded border border-border">
              ...
              <div className="flex flex-wrap gap-4">
                <span className="px-3 py-1 bg-white border border-border rounded-full text-sm font-medium">Traceable</span>
                <span className="px-3 py-1 bg-white border border-border rounded-full text-sm font-medium">Tunable</span>
                <span className="px-3 py-1 bg-white border border-border rounded-full text-sm font-medium">Accountable</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
           ...
           <div className="grid md:grid-cols-4 gap-6">
             {[
               ...
               <div key={i} className="bg-white p-6 rounded-lg border border-border relative group hover:-translate-y-1 transition-transform duration-300">
                 <div className="text-4xl font-bold text-border mb-4 group-hover:text-secondary/20 transition-colors">{phase.step}</div>
